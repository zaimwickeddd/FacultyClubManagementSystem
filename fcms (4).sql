...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 07, 2026 at 12:50 AM
...
(2, 'MASPENA', 'club for pentadbiran awam\r\n', 2),
(3, 'BASiS', 'club for pentadbiran awam\r\n', 2);
...
CREATE TABLE `clubeventapplication` (
  ...
  `EventBudget` decimal(10,2) DEFAULT NULL,
  `ClubID` int(11) DEFAULT NULL,
  `ApproverID` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `clubeventapplication`
--

INSERT INTO `clubeventapplication` (`CEAppID`, `CEAppStatus`, `EventDescription`, `EventCategory`, `EventBudget`, `ClubID`, `ApproverID`) VALUES
(1, 'Approved', NULL, NULL, NULL, 1, 1001),
(2, 'Approved', NULL, NULL, NULL, 1, 1001),
(3, 'Approved', NULL, NULL, NULL, 1, 1001),
(6, 'Approved', 'Bond', NULL, 0.00, 1, NULL),
(7, 'Rejected', 'To create non-tech', NULL, 0.00, 1, NULL),
(17, 'Rejected', 'aerospace', NULL, 0.00, 1, NULL);
...
(1, 'HACKATHON INTERNATIONAL', '2026-05-12', '09:00:00', 'Dewan Agong', 'Upcoming', 0, 1, 1),
(2, 'COMPASS FAMILY DAY', '2026-06-02', '08:00:00', 'UiTM Field', 'Upcoming', 0, 1, 2),
(3, 'FEST-BAF 2026', '2026-08-12', '10:00:00', 'Lobby FSKM', 'Upcoming', 0, 1, 3),
(5, 'Anual Gather Meet', '2026-02-11', '01:38:00', 'BSU', 'Upcoming', 0, 1, 6),
(6, 'Team Building', '2026-02-12', '02:48:00', 'Taman Sri Perkasa', 'Rejected', 0, 1, 7),
(16, 'Tech aerospace', '2026-02-07', '10:00:00', 'UiTM DJ', 'Rejected', 0, 1, 17);
...
(5, '2026-02-06', 2, 3001, 'PENDING'),
(6, '2026-02-06', 3, 3001, 'PENDING');
...
(1001, 'zaim', 'zaim@uitm.edu.my', NULL, NULL, 'Advisor', 'zaim123', 1, 1, '2026-01-17 00:39:51', '2026-02-06 23:15:59'),
...
--
-- AUTO_INCREMENT for table `clubeventapplication`
--
ALTER TABLE `clubeventapplication`
  MODIFY `CEAppID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `eventregistration`
  MODIFY `RegisID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `UserID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3006;
